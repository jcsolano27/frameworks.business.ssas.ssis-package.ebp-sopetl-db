CREATE FUNCTION [dbo].[fnGetEsdVersionByStrategyMonth]()
RETURNS @EsdVersionByStrategyMonth TABLE(PlanningMonth INT, EsdVersionId INT, SvdSourceVersionId INT, ReferencePlanningMonth INT)
AS
/* Testing harness
	select * from dbo.[fnGetEsdVersionByStrategyMonth]()
--*/
BEGIN
    DECLARE @SvdSourceApplicationId_ESD INT = [dbo].[CONST_SvdSourceApplicationId_ESD]()

    INSERT @EsdVersionByStrategyMonth
