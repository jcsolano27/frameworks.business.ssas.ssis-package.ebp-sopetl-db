CREATE TABLE [dbo].[EsdSupplyByFgWeek] (
    ...
    [CreatedOn]         DATETIME     CONSTRAINT [DF_EsdDataSupplyStitch_CreatedOn] DEFAULT (getdate()) NOT NULL,
    [CreatedBy]         VARCHAR (25) CONSTRAINT [DF_EsdDataSupplyStitch_CreatedBy] DEFAULT (original_login()) NOT NULL,
    CONSTRAINT [PK_EsdDataSupplyStitch] PRIMARY KEY CLUSTERED ([ItemName] ASC, [YearWw] ASC)
);
