CREATE   PROC [dbo].[UspSvdBeginBatchRun]

--EXEC [dbo].[UspSvdBeginBatchRun]
...
----*********************************************************************************************
----    2023-07-24	fgarc20x		Included 'DISTINCT' in StgSvdLoadStatus table to eliminate duplicate 
--									records from Hana (when there is a version name update)
----*********************************************************************************************  
*************************************************************************************************/ 
...
BEGIN TRY
    ...
    --SELECT @CurrentAction = 'Starting work';
		...
		UPDATE [dbo].[SvdLoadStatus] 
		   ...
		   FROM [dbo].[SvdLoadStatus] tb1  
				INNER JOIN [dbo].[StgSvdLoadStatus] tb2 ON tb1.SourceNm = tb2.LoadSourceNm
