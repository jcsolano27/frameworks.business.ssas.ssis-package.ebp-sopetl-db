CREATE   PROC [dbo].[UspEtlLoadAllocationBacklog]
    @Debug TINYINT = 0,
...
----    Purpose:        Load data to AllocationBacklog
...
BEGIN TRY
    ...
    FROM [dbo].[StgAllocationBacklog] AS B
    ...
    EXEC [dbo].[UspProfitCenterDistribution] @InputTable = @InputTable,
    ...
    WHEN NOT MATCHED BY TARGET THEN
        ...
        VALUES
        (S.SourceApplicationName, S.PlanningMonth, S.SnOPDemandProductId, S.ProfitCenterCd, S.YearWw, S.Quantity,
