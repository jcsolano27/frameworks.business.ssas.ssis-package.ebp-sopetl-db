CREATE TABLE [sop].[TableLoadGroupMap] (
    ...
    CONSTRAINT [FK_TableLoadGroupMap_TableId] FOREIGN KEY ([TableId]) REFERENCES [sop].[EtlTables] ([TableId]),
    CONSTRAINT [FK_TableLoadGroupMap_TableLoadGroupId] FOREIGN KEY ([TableLoadGroupId]) REFERENCES [sop].[TableLoadGroup] ([TableLoadGroupId])
);
