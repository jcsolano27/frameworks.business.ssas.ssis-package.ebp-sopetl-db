CREATE TABLE [sop].[StgItemDetail] (
    ...
    [DeleteInd]                       INT              NULL,
    [CreatedOnDtm]                    DATETIME         CONSTRAINT [DF_StgItemDetail_CreatedOnDtm] DEFAULT (getdate()) NOT NULL,
    [CreatedByNm]                     VARCHAR (25)     CONSTRAINT [DF_StgItemDetail_CreatedByNm] DEFAULT (original_login()) NOT NULL
);
