CREATE TABLE [sop].[DemandForecast] (
    ...
    CONSTRAINT [Pk_DemandForecast] PRIMARY KEY CLUSTERED ([PlanningMonthNbr] ASC, [PlanVersionId] ASC, [ProductId] ASC, [ProfitCenterCd] ASC, [KeyFigureId] ASC, [TimePeriodId] ASC, [SourceSystemId] ASC),
    ...
    CONSTRAINT [FK_DemandForecast_TimePeriodId] FOREIGN KEY ([TimePeriodId]) REFERENCES [sop].[TimePeriod] ([TimePeriodId])
);
